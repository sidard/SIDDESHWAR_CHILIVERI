...
void main(void) {
    ...
    uint8_t TransmitBuffer=Transfer_Buffer_0;
    uint8_t MsgID=Instrument_Cluster_Msg_ID;
    uint8_t Tx_Instrument_Cluster_DataBytes[8];
    uint8_t Rx_Cruise_Control_Warning_Lamp;
    uint8_t ReadfromEEPROM[16];
